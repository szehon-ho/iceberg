...
public class AbstractScanTaskSetManager<F extends ScanTask> {

  private final Map<Pair<String, String>, List<F>> tasksMap = Maps.newConcurrentMap();

  AbstractScanTaskSetManager() {}

  public void stageTasks(Table table, String setID, List<F> tasks) {
  ...
  public List<F> fetchTasks(Table table, String setID) {
    Pair<String, String> id = toID(table, setID);
    return tasksMap.get(id);
  }

  public List<F> removeTasks(Table table, String setID) {
    Pair<String, String> id = toID(table, setID);
