...
public class AwsKmsClient implements KmsClient {
  ...
  public void initialize(Map<String, String> kmsClientTableProperties) {
    ...
    enableKeyGeneration =
        Boolean.parseBoolean(kmsClientTableProperties.getOrDefault(ENABLE_KEY_GENERATION, "true"));
    // this will be deleted once we make KMS Client injected with Catalog properties instead of
    // table properties.
    Map<String, String> factoryProperties = Maps.newHashMap();
