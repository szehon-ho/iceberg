...
| [v3](#version-3) | **`geometry(C, E)`** | Geometry features from [OGC – Simple feature access](https://portal.ogc.org/files/?artifact_id=25355). See [Appendix G](#appendix-g-geospatial-notes)). Parameterized by crs C [4] and edges E [5]. If not specified, C is OGC:CRS84 and E is planar. |                                                        |
...
5. Edges is the interpretation for non-point geometries in geometry object. Possible values are 'planar' (an edge between points represents a straight cartesian line) and 'spherical' (an edge between points is the shortest line on the sphere). Fixed and cannot be changed by schema evolution.
...
| **`geometry(C, E)`**                        | `JSON object: {`<br />&nbsp;&nbsp;`"type": "geometry",`<br />&nbsp;&nbsp;`"crs": <C>,`<br />&nbsp;&nbsp;`"edges": <E>`<br />`}`                                                                                                                                                                                                                                                                                                                                                                                                                       | `{`<br />&nbsp;&nbsp;`"type": "geometry",`<br />&nbsp;&nbsp;`"crs": "OGC:CRS84",`<br />&nbsp;&nbsp;`"edges": "planar"`<br />`}`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
